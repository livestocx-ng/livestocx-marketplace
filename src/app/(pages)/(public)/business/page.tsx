			...
			<main className='relative'>
				...
				<section className='w-full bg-gradient-to-b from-green-800 to-green-50 flex flex-col md:flex-row items-center justify-between px-4 md:px-8 pt-20'>
					<div className='flex flex-col space-y-4 w-full md:w-[45%]'>
						...
						<p className='text-sm md:text-lg text-white font-medium text-center md:text-left leading-8'>
							...
							Marketplace and showcase your products with our
							custom website and catalog built for you.
						</p>
				...
				<div className='space-y-10 my-14'>
					...
					<div className='flex flex-wrap items-start justify-between w-full px-4 md:px-8'>
						<div className='h-[240px] md:h-[400px] w-full md:w-[45%] relative mb-10 md:mb-0'>
							<Image
								alt=''
								fill
						...
						<div className='w-full md:w-[50%] space-y-10'>
							<div className='space-y-3 list-none'>
								...
								/> */}
									...
									<p className='text-sm md:text-base w-[90%] md:w-[95%]'>
										Have a mini-website/online store for
										your business that you can share with
										your customers.
									</p>
								</div>
								<div className=' flex items-start justify-between space-x-'>
								...
								/> */}
									...
									<p className='text-sm md:text-base w-[90%] md:w-[95%]'>
										Have access to analytics and sales
										features.
									</p>
								</div>
							</div>
							...
							<div className='flex flex-col space-y-2'>
								...
								<p className='text-sm md:text-base'>
									Thanks to Livestocx, my poultry business now
									has a professional online presence. The
									platform's features are top-notch, and the
									ease of setting up a custom store has saved
									me so much time. Sales have never been
									better!
								</p>
							</div>
						</div>
				...
				<div className='w-full py-5 px-4 md:px-[160px] my-10 flex flex-col space-y-5'>
					...
					<p className='text-sm md:text-lg'>
						You can now seamlessly integrate your Livestocx catalog
						or products into your existing website, similar to how
						Calendly and Typeform work. This powerful feature allows
