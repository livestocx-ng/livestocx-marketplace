		...
		<main>
			...
			<div className='w-full py-10 px-4 md:px-8 flex flex-col space-y-5'>
				...
				<p className='text-sm leading-7'>
					...
					of the livestocx.com website (“Website” or “Service”) and
					any associated products and services (“Services”). This
					Agreement establishes a legally binding relationship between
					you (“User”, “you”, or “your”) and the operator of this
					Website (“Operator”, “we”, “us”, or “our”). Should you be
					entering into this agreement on behalf of a business or
				...
				<ol className='list-decimal space-y-5 px-4'>
					...
					<li className='text-sm leading-7'>
						...
						or losses arising from your use of the Website, blood
						donation activities, or reliance on any information
						provided through the Website. To the broadest extent
					...
					<li className='text-sm leading-7'>
						...
						terminate the Website at any time, with or without
						notice. We may also update these Terms to reflect any
					...
					<li className='text-sm leading-7'>
						...
						on the Website. The accuracy, quality, integrity,
						legality, reliability, appropriateness, and ownership or
						rights to use all submitted Content rest solely with
						you. The Content submitted or generated by you on the
						Website using our Services may be monitored and reviewed
						by us. By using our Services, you grant us the
						permission to access, copy, distribute, store, transmit,
						reformat, display, and perform the Content associated
						with your user account, strictly for the purpose of
						delivering the Services to you.While we don’t have an
						obligation to do so, we retain the right to exercise our
						discretion and, if deemed necessary, reject or eliminate
						any Content that, in our reasonable judgment, breaches
						any of our policies or is considered harmful or
						objectionable. Additionally, you provide us with a
						license to utilize, reproduce, adapt, modify, publish,
						or distribute the Content you create or store in your
