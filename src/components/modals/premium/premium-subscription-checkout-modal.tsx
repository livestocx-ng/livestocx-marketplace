					...
					<div className='flex flex-col space-y-2 w-full py-3'>
						...
						<div className='w-full'>
							...
							<FormTextInput
								...
								handleChange={handleChange}
								placeHolder='Enter facebook storename to see how your handle will look'
								classes='w-full text-sm placeholder:text-xs border focus:border-slate-500 rounded'
							/>
						</div>
						...
						<div className='w-full'>
							...
							<FormTextInput
								...
								handleChange={handleChange}
								placeHolder='Enter twitter store name to see how your handle will look'
								classes='w-full text-sm placeholder:text-xs border focus:border-slate-500 rounded'
							/>
						</div>
						...
						<div className='w-full'>
							...
							<FormTextInput
								...
								handleChange={handleChange}
								placeHolder='Enter instagram storename to see how your handle will look'
								classes='w-full text-sm placeholder:text-xs border focus:border-slate-500 rounded'
							/>
						</div>
