          ...
          <div className="w-full lg:w-[30%] flex flex-col space-y-5">
            ...
            <div className="flex flex-row-reverse md:flex-row items-center md:items-start space-x-5">
              ...
              <p className="text-xs text-red-500">
                Add pictures of product (maximum of 3 images 3MB each).{" "}
                ...
                <Button
                  ...
                  onClick={() => {
                    updateFormData({
                      type: "UPDATE_FORMDATA",
                      payload: {
                        media: formData.media.filter((media) =>
            ...
            {formData.media.length > 0 && (
              <p className="text-center text-xs font-semibold">
                {getFilesTypeCount(formData.media, "image")} Images |{" "}
                {getFilesTypeCount(formData.media, "video")} Videos
              </p>
            )}
          </div>
