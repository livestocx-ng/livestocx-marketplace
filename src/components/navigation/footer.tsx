...
const Footer = () => {
	...
	return (
		<div className='pt5 md:pt10 w-full bg-main flex flex-col'>
			<div className='flex flex-row flex-wrap items-start justify-between w-full'>
				<div className='flex flex-col justify-between w-full pt-5 md:pt-10  bg-white'>
					<div className='flex justify-center items-center text-whte text-md md:text-xl mb-5'>
						Backed by
					</div>
					<div className='overflow-hidden w-full'>
						<motion.div
							...
							className='flex flex-row flex-wrap items-center justify-center gap-4 w-full pb-5'
							animate={{
								x: [0, -1000],
							}}
							transition={{
				...
				<div className='px-5 sm:px-10 pt-10 flex flex-row flex-wrap items-start justify-between w-full'>
					<div className='mb-10 sm:mb-0 flex flex-col space-y-5 w-full md:w-fit'>
						...
						<div className='flex flex-col items-start space-y-2'>
							...
							<div className='space-y-1'>
								<p className='text-white text-xs'>
									Shimex Estate Lugbe Federal Capital
									Territory, Nigeria.
								</p>
								<p className='text-white text-xs'>
									{/* +2348132549273 */}
